...
final class InitialFolderURLResolverTests: XCTestCase {
    ...
    private func temporaryDirectory() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appending(path: "locus-initial-folder-tests-\(UUID().uuidString)", directoryHint: .isDirectory)
    ...
    private func temporaryFile() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appending(path: "locus-initial-folder-tests-\(UUID().uuidString).txt", directoryHint: .notDirectory)
