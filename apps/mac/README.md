...
- `Locus/Views/Home`: current folder browsing, inline folder expansion, Git change coloring in the sidebar, inline sidebar file/folder creation and deletion, recent locations, search ranking support, preview routing, text editing with native line-number gutters for editable text formats, and open-document change sync.
