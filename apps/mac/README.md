...
- `Locus/Views/Home`: current folder browsing, inline folder expansion, inline sidebar file/folder creation, recent locations, search ranking support, preview routing, text editing with native line-number gutters for editable text formats, and open-document change sync.
