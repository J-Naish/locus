...
- `Locus/Views/Home`: current folder browsing, inline folder expansion, recent locations, document tabs, search ranking support, preview routing, text editing, and open-document change sync.
